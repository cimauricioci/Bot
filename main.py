            ...
            if(len(game['promotions']['promotionalOffers']) > 0):
                ...
                if startDate <= now and now <= endDate:
                    ...
                    if int(discountPrice) == 0:
                        ...
                        # print(f"URL do jogo na Epic Games: https://www.epicgames.com/store/pt-BR/p/{game['productSlug']}")
                        ...
                        urlParaDownload = f"https://www.epicgames.com/store/pt-BR/p/{game['productSlug']}"
    ...
    for guild in client.guilds:
        for canal in [g.id for g in guild.text_channels if g.name == "geral"]:
            ...
            for jogo in jogos:
                ...
                # await channel.purge(limit=40, check=lambda message: message.author == client.user)
